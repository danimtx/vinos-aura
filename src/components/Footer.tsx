...
export default function Footer() {
  return (
    <footer className="py-12 px-8 bg-background border-t border-white/5 text-center text-muted font-sans font-light">
      ...
      <div className="text-xs uppercase tracking-widest flex flex-col items-center gap-4">
        <p>© 2026 VINOS AURA. Todos los derechos reservados.</p>
        <a
          href="/politicas/PoliticadePrivacidad.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-primary border-b border-transparent hover:border-primary pb-0.5 transition-colors"
        >
